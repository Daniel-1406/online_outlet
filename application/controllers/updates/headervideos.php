...
class headervideos extends CI_Controller {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('updates/headingvideos', $data);
                ...
                if (!$this->upload->do_upload('userfile')) {
                    ...
                    $data["msg"] = $this->headermodel->updatevideos($rec);
