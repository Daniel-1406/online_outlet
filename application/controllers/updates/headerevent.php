...
class headerevent extends CI_Controller {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('updates/headingevent', $data);
                ...
                if (!$this->upload->do_upload('userfile')) {
                    ...
                    $data["msg"] = $this->headermodel->updateevent($rec);
