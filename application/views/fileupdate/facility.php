                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updatefacility/do_upload");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php print form_hidden("id", set_value("id", ''), 'class="form-control" id="exampleInputEmail1" placeholder="Facility name"') ?>
