                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title-danger">Member's Center Banner</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updates/headermemcenter/do_upload");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("subtitle", set_value("subtitle", $subtitle), 'class="form-control" id="exampleInputEmail1" ') ?>
                                        </div>
                                        <div class="form-group">  
