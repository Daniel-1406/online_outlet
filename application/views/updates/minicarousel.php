                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="card card-primary">
                                    <div class="card-header"><h3>Mini Carousel</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updates/minicarousel/do_upload");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("text", set_value("text", $text), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Text..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Label</label>
                                            <?php print form_input("label", set_value("label", $label), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Label..."') ?>
                                        </div>
                                        <div class="form-group">
