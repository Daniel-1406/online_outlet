        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content"> 
                    <div class="container-fluid">
                        <?php print form_open_multipart("welcome/updatechurchinfo"); ?>
                        <div class="row">
                            <!-- left column -->
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    ...
                                    ?>
                                    <div class="card-body">
                                        <?php print form_open("welcome/updatechurchinfo"); ?>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <label for = "exampleInputFile">About Heading</label>
                                            <div class = "input-group">
                                                <?php print form_input("heading",  set_value("heading",$heading),'class = "form-control" placeholder = "Enter About Heading"')?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group my-colorpicker2">
                                                <?php print form_input("maj_color",  set_value("maj_color",$maj_color),'class = "form-control" ')?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group my-colorpicker3">
                                                ...
                                                <?php print form_input("min_color",  set_value("min_color",$min_color),'class = "form-control" ')?>
