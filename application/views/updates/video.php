                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    <div class="card-header"><h3>Video Update</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updates/video_upload/do_upload");
                                    ...
                                    <div class="form-group">  
                                            ...
                                            <?php print form_input("topic", set_value("topic",$topic), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Video Heading..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Speaker</label>
                                            <?php print form_input("speaker", set_value("speaker",$speaker), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Speaker Name..."') ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Summary</label>
                                            <?php print form_textarea("summary", set_value("summary",$summary), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Video Summary ..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Date</label>
                                            <?php print form_input("date", set_value("date",$date), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Date..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Link</label>
                                            <?php print form_input("link", set_value("link",$link), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Video Link..."') ?>
                                        </div>
                                        <div class="form-group">
