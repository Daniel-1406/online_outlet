                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updates/service/do_upload");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("title", set_value("title", $title), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Program Title..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Set Duration</label>
                                            <?php print form_input("duration", set_value("duration",$duration), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Program Duration..."') ?>
                                        </div>
