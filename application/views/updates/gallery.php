                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updates/gallery/do_upload");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">  
                                            <label  ><img src="<?php print base_url('images/' . $name) ?>" width='100%' height='300px'></label>
                                        ...
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("caption", set_value("caption", $caption), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Photo Caption..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1"> Category</label>
                                            <?php print form_input("category", set_value("category", $category), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Category..."') ?>
                                        </div>
