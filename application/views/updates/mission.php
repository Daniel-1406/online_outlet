                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="card card-primary">
                                    <div class="card-header"><h3>Mission and beliefs</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updates/display/updatemission");
                                    echo '<div class="bg-danger" style="text-align:center;"><b>' . validation_errors() . '</b></div>';
                                     ?>
                                    <div class="card-body">
                                        <div class="form-group">
                                        <label for="exampleInputEmail1">Mission and beliefs</label>
