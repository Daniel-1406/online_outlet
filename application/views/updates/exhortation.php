                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="card card-primary">
                                    <div class="card-header"><h3>Exhortation Update</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updates/exhortation/do_upload");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("title", set_value("title", $title), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Exhortation Title..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Author</label>
                                            <?php print form_input("author", set_value("author", $author), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Author..."') ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Exhortation Date</label>
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <?php print form_input("date", set_value("date",$date), 'type="date" class="form-control" id="exampleInputEmail1" class="form-control datetimepicker-input" data-target="#reservationdate" placeholder="Enter Exhortation Date..."') ?>
                                      ...
                                      <div class="form-group">  
                                            ...
                                            <?php print form_textarea("summary", set_value("summary", $summary), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Exhortation Summary..."') ?>
                                        </div>
                                        <div class="form-group">
