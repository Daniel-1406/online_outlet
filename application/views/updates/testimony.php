                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updates/testimony/do_upload");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("name", set_value("testifier", $name), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Testifier Name..."') ?>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">  
                                            ...
                                            <?php print form_textarea("testimony", set_value("testimony", $testimony), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Photo Caption..."') ?>
                                        </div>
