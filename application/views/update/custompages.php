                            ...
                            <div class="col-md-12"> 
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title-danger">Update Page</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updatecustompage/do_upload");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("name", set_value("name", $name), 'class="form-control" id="exampleInputEmail1" placeholder="Page name ..."') ?>
                                            <!--<input type="text" >-->
                                        </div>
                                        <div class="form-group">
                                            <label>Date:</label>
                                    ...
                                    <div class="card-footer">
                                        <?php print form_submit("Submit", "Update Page", 'class="btn btn-primary"') ?>
...
<!-- Summernote -->
<script src="<?php print base_url() ?>plugins/summernote/summernote-bs4.min.js"></script>
...
<script type="text/javascript">
    ...
    myDropzone.on("addedfile", function(file) {
        // Hookup the start button         file.previewElement.querySelector(".start").onclick = function() {
