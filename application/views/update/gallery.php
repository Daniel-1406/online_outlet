                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updategallery/do_upload");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("title", set_value("title", $title), 'class="form-control" id="exampleInputEmail1" placeholder="Photo title"') ?>
                                            <!--<input type="text" >-->
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Numbering</label>
                                            <?php print form_input("numbering", set_value("numbering", $numbering), 'class="form-control" id="exampleInputEmail1" placeholder="Photo order number"') ?>
                                            <!--<input type="text" >-->
                                        </div>
