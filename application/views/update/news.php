                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title-danger">Update News Information</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("updatenews/do_upload");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("name", set_value("name", $name), 'class="form-control" id="exampleInputEmail1" placeholder="Enter news title"') ?>
                                            <!--<input type="text" >-->
                                        </div>
                                        <div class="form-group">
                                            <label>Event Date:</label>
                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <?php print form_input("date", set_value("date", $date), 'class="form-control datetimepicker-input" data-target="#reservationdate"') ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php print form_textarea("description", set_value("description", $description), 'class="form-control" id="exampleInputEmail1" placeholder="Enter event description"') ?>
                                            <!--<input type="text" >-->
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        <?php print form_submit("Submit", "Update Information", 'class="btn btn-primary"') ?>
