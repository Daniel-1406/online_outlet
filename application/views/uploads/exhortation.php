                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="card card-primary">
                                    <div class="card-header"><h3>Exhortation Upload</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("uploads/exhortation/do_upload");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Exhortation Title</label>
                                            <?php print form_input("title", set_value("title", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Exhortation Title..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Author</label>
                                            <?php print form_input("author", set_value("author", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Author..."') ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Exhortation Date</label>
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <?php print form_input("date", set_value("date", ""), 'type="date" class="form-control" id="exampleInputEmail1" class="form-control datetimepicker-input" data-target="#reservationdate" placeholder="Enter Exhortation Date..."') ?>
                                      ...
                                      <div class="form-group">  
                                            <label for="exampleInputEmail1">Exhortation Summary</label>
                                            <?php print form_textarea("summary", set_value("summary", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Service Summary..."') ?>
                                        </div>
                                        <div class="form-group">
                                        <label for="exampleInputEmail1">Exhortation Information</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="exampleInputFile">Choose Overlay Photo</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        <?php print form_submit("Submit", "Post", 'class="btn btn-primary "') ?>
  ...
  $(function () {
    ...
    CodeMirror.fromTextArea(document.getElementById("codeMirrorDemo"), {
      ...
      theme: "monokai"
            ...
            <!-- dropzonejs -->
            <script src="<?php echo base_url();?>/dropzone/min/dropzone.min.js"></script>
            <!-- AdminLTE App -->
            <script>
              $(function () {
