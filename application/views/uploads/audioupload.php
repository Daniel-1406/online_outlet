                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    <div class="card-header"><h3>Audio Upload</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("audio/do_upload");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <label class="custom-file-label" for="exampleInputFile">Upload Audio</label> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1"> Audio Title</label>
                                            <?php print form_input("title", set_value("title", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Audio Title..."') ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <?php print form_submit("Submit", "Upload Audio", 'class="btn btn-primary "') ?>
