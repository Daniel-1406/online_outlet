                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="card card-primary">
                                    <div class="card-header"><h3>Custom Page Upload</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("uploads/page/pageupload");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("name", set_value("name", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Page Title..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Page Identifier</label>
                                            <?php print form_input("identifier", set_value("identifier", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Page Identifier..."') ?>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <?php print form_input("date", set_value("date", ""), 'type="date" class="form-control" id="exampleInputEmail1" class="form-control datetimepicker-input" data-target="#reservationdate" placeholder="Enter Page Date..."') ?>
                                    ...
                                    <div class="card-footer">
                                        <?php print form_submit("Submit", "Upload Page", 'class="btn btn-primary "') ?>
