                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("uploads/minicarousel/do_upload");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("text", set_value("text", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Text..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Label</label>
                                            <?php print form_input("label", set_value("label", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Label..."') ?>
                                        </div>
                                        <div class="form-group">
