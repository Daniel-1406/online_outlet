                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("leadershipteam/do_upload");
                                    ...
                                    <div class="form-group">  
                                            ...
                                            <?php print form_input("name", set_value("name", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Full Name..."') ?>
                                        </div>
                                        <div class="form-group">  
                                            <label for="exampleInputEmail1">Leadership Position</label>
                                            <?php print form_input("position", set_value("position", ""), 'class="form-control" id="exampleInputEmail1" placeholder="Enter Leadership Position..."') ?>
                                        </div>
