                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("uploads/details/menupages/updatecareer");
                                    ...
                                    <div class="form-group">  
                                        ...
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("location", set_value("location",$location), 'class="form-control" id="exampleInputEmail1"') ?>
                                            <!--<input type="text" >-->
                                        </div>
