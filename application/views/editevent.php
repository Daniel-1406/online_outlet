                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <?php
                                    print form_open_multipart("eventupdate/do_upload");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">  
                                            ...
                                            <?php print form_input("name", set_value("name", $name), 'class="form-control" id="exampleInputEmail1" placeholder="Enter event name"') ?>
                                            <!--<input type="text" >-->
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        <?php print form_submit("Submit", "Update Event", 'class="btn btn-primary"') ?>
